...
import com.hsf.stdntapt.dao.ResourceDao;
...
public class ResourceDaoImpl implements ResourceDao {
	...
	public void deleteResource(Long resourceId) {
		...
		final String deleteSelfSql = "delete from resource where id=?";
		jdbcTemplate.update(deleteSelfSql, resourceId);
		final String deleteDescendantsSql = "delete from resource where parent_ids like ?";
		jdbcTemplate.update(deleteDescendantsSql, resource.makeSelfAsParentIds() + "%");
	}

	@Override
	public Resource findOne(Long resourceId) {
		final String sql = "select id, name, type, url, permission, parent_id, parent_ids, available from resource where id=?";
	...
	public List<Resource> findAll() {
		final String sql = "select id, name, type, url, permission, parent_id, parent_ids, available from resource order by concat(parent_ids, id) asc";
